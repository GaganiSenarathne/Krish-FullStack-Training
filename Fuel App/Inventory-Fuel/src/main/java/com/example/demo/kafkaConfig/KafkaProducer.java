...
//		Mapping KAFKA Producer configurations
    ...
    @Bean
    ProducerFactory<String, InventoryReserved> producerFactory() {
//    	Return the Producer instance 
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    KafkaTemplate<String, InventoryReserved> kafkaTemplate(ProducerFactory<String, InventoryReserved> producerFactory) {
