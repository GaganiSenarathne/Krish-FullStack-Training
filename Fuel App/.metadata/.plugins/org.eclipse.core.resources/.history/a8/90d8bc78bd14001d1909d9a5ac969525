...
//			String status = "Allocated";
			...
			int existUsableCapacity = inventoryUsable.getQty();
			
//			String status = "Allocated";
			int usableExCapacity  = existUsableCapacity - Capacity;
			
			usable.setQty(usableExCapacity);
			
			updateFuelUsable(inventoryUsable, usableExCapacity);
		}
